...
export default function GlobalLandingPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 font-['Outfit'] flex flex-col items-center justify-center p-4 transition-colors">
      ...
      <div className="z-10 w-full max-w-4xl text-center mb-16">
        <h1 className="text-6xl md:text-8xl font-black tracking-tighter bg-clip-text text-transparent bg-gradient-to-br from-indigo-700 via-indigo-500 to-violet-500 dark:from-white dark:via-indigo-200 dark:to-indigo-500 mb-6 drop-shadow-sm">
          MedCamp.
        </h1>
      ...
      <div className="z-10 grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-5xl">
        ...
        <div className="bg-white dark:bg-white/5 backdrop-blur-xl border border-slate-200 dark:border-white/10 shadow-xl dark:shadow-none rounded-3xl p-8 hover:bg-slate-50 dark:hover:bg-white/10 transition-colors">
          ...
          <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-3">Staff & Admin Portal</h2>
          <p className="text-slate-500 dark:text-slate-400 mb-8 leading-relaxed">Deploy a brand new medical camp ecosystem or access your existing live deployment.</p>
          ...
          <div className="space-y-4">
            <form onSubmit={handleAccessCamp} className="flex gap-2">
              <input 
                ...
                className="flex-1 bg-slate-50 dark:bg-slate-900/50 border border-slate-300 dark:border-slate-700 text-slate-900 dark:text-white rounded-xl px-4 py-3 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all placeholder:text-slate-400 dark:placeholder:text-slate-600 font-mono uppercase"
              />
            ...
            <Link href="/admin/setup" className="block w-full text-center bg-slate-900 dark:bg-white text-white dark:text-slate-900 hover:bg-slate-800 dark:hover:bg-slate-200 px-6 py-4 rounded-xl font-black transition-all shadow-xl shadow-slate-900/5 dark:shadow-white/5">
              Launch New Camp
            </Link>
          </div>
        </div>
        ...
        {/* Patient Portal */}
        <div className="bg-white dark:bg-white/5 backdrop-blur-xl border border-slate-200 dark:border-white/10 shadow-xl dark:shadow-none rounded-3xl p-8 hover:bg-slate-50 dark:hover:bg-white/10 transition-colors flex flex-col">
          ...
          <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-3">Patient Portal</h2>
          <p className="text-slate-500 dark:text-slate-400 mb-8 leading-relaxed flex-1">Access your historical medical reports, prescriptions, and post-camp follow-up instructions securely.</p>
